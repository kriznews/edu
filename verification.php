              ...
              <form action="" name="verify_purchase" method="post" class="form form-horizontal" enctype="multipart/form-data" id="api_form">
                ...
                <div class="section-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="envato_buyer_name" readonly id="envato_buyer_name" value="NullJungle" class="form-control" placeholder="viaviwebtech">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="envato_purchase_code" id="envato_purchase_code" value="Nulled-By-NullJungle" class="form-control" placeholder="xxxx-xxxx-xxxx-xxxx-xxxx">
                    </div>
                  </div>
                  <div class="form-group">
